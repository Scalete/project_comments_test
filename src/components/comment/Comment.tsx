...
const CommentMobile: FC<{isUser: boolean, isReply: boolean, setIsReply: any, setIsEdit: any}> = ({isUser, isReply, setIsReply, setIsEdit}) => {
    ...
    return (
        <div className={styles.mobileActions}>
            ...
            {
                !isUser? (
                    <button onClick={() => {console.log(isReply); setIsReply((prev: boolean) => !prev)}} className={`${styles.commentHeaderReply}`}>
        ...
        <div className={styles.container}>
            <div className={styles.comment}>
                ...
                <div className={styles.commentWrapper}>
                    ...
                    <CommentMobile isUser={isUser} isReply={true} setIsReply={setIsReply} setIsEdit={setIsEdit}/>
                </div>
            </div>
            {
